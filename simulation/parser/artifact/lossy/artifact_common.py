#!/usr/bin/env python3
"""Shared helpers for lossy artifact parser wrappers.
...
OUTPUT_NAMES = {
    "fig11": "fig11_lossy_dcn_p99_fct_leafspine",
    "fig12": "fig12_lossy_dcn_p99_fct_fattree",
    "fig13": "fig13_lossy_ai_collective_cct",
}
