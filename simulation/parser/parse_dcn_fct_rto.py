...
def get_steps_from_raw(filename, time_start, time_end, num_buckets=20):
    ...
    for i in range(num_buckets):
        ...
        current_res.append(fct[-1]) # Tail (worst) slowdown
        res.append(current_res)
    # --- END OF MODIFICATION ---
...
def main():
    ...
    parser.add_argument('-o', '--output_dir', type=str, default=None,
                        help='Output directory for JSON files (default: ./json-data-fct-asy-final/).')
    ...
    if args.output_dir:
        ...
        json_dir = os.path.join(file_dir, "json-data-fct-asy-final/")
            ...
            if os.path.exists(fct_slowdown_file):
                ...
                if result and result["avg"]:
                    series_data = {
                        ...
                        # "p50_fct_slowdown": result["p50"],
                        # "p80_fct_slowdown": result["p80"],
                        # "p90_fct_slowdown": result["p90"],
                        # "p95_fct_slowdown": result["p95"],
                        "p99_fct_slowdown": result["p99"],
                        # "p999_fct_slowdown": result["p999"],
                        # "tail_fct_slowdown": result["tail"],
