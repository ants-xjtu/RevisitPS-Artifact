...
class ConWeaveRouting : public Object {
   ...
   public:
    ...
    static uint64_t CalculateTimegapAtTx(uint64_t tailTime, Time phase0TxTime,
                                         bool* inconsistentTailTime = 0);
    ...
    static uint64_t m_nInvalidTailTime; // number of invalid tailTime < phase0TxTime observations
