...
def main() -> int:
    ...
    with temporary_input_dir(args.input_dir, "fig12", dry_run=args.dry_run) as staged:
        run_bazel("//main/plot_sample:plot_dcn_rto_fct", [staged], dry_run=args.dry_run)
        copy_matching(staged, "*.pdf", args.output_dir, "fig12_lossy_dcn_p99_fct_fattree", dry_run=args.dry_run)
    return 0
