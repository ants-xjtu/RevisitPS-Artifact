...
def main() -> int:
    ...
    with temporary_input_dir(args.input_dir, "fig15", dry_run=args.dry_run) as staged:
        ...
        copy_file(staged / OOO_JSON.replace(".json", "_dist_cdf.pdf"), args.output_dir / "fig15_asym_ooo_degree.pdf", dry_run=args.dry_run)
        ...
        copy_file(staged / "plot_fig15_asym_ooo_retransmission_retrans_trace_unnecessary_retrans.pdf", args.output_dir / "fig15_asym_unnecessary_retransmission.pdf", dry_run=args.dry_run)
    return 0
