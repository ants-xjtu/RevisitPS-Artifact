...
def main() -> int:
    ...
    with temporary_input_dir(args.input_dir, "fig10", dry_run=args.dry_run) as staged:
        input_json = staged / "fig10_lossless_spine_queue_timeseries.json"
        ...
        copy_file(staged / f"spine_{args.spine_id}_egress_qlen.pdf", args.output_dir / "fig10_lossless_spine_queue_timeseries.pdf", dry_run=args.dry_run)
    return 0
